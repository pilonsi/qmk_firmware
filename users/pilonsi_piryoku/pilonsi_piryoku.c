...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT_piryoku(
    ...
    U_NP,              U_NP,              LT(MESH, KC_ESC),  LT(NAV, KC_SPC),   LT(CAT, KC_TAB),   LT(SYM, KC_ENT),   LT(NUM, KC_BSPC),  LT(FUN, KC_DEL),   U_NP,              U_NP
  ),
  [NAV] = LAYOUT_piryoku(
  ...
  [CAT] = LAYOUT_piryoku(
    RESET,   U_NA,    U_NA,    U_NA,    U_NA,    CA_LCLL, CA_PVOL, CA_OEXL, CA_OINT, CA_RCLL,
    KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, U_NA,    CA_ENYA, CA_CETR, CA_ACTA, CA_ACOB, CA_DIER,
    U_NA,    KC_ALGR, U_NA,    U_NA,    U_NA,    U_NU,    CA_LLAE, CA_LLOE, CA_ACCF, U_NU,
    U_NP,    U_NP,    U_NA,    U_NA,    U_NA,    KC_ENT,  KC_BSPC, KC_DEL,  U_NP,    U_NP
  ),
  [MESH] = LAYOUT_piryoku(
    RESET,             KC_F5,             KC_F3,             KC_F1,             A(KC_G),           RGB_TOG,           RGB_MOD,           RGB_HUI,           RGB_SAI,           RGB_VAI,
    LGUI_T(U_UND),     LALT_T(U_CUT),     LCTL_T(U_CPY),     LSFT(U_PST),       U_RDO,             KC_MPRV,           KC_VOLD,           KC_VOLU,           KC_MNXT,           U_NU,
    U_NU,              U_NA,              KC_BSPC,           KC_DEL,            U_NU,              U_NU,              U_NU,              U_NU,              U_NU,              U_NU,
